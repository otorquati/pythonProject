...
user_input = input("Entre seu objetivo com o prazo separado por :\n")
...
print(f"Caro usuário! O prazo para atingir seu objetivo: {goal} é {time_till.total_seconds() / 60 / 60} horas")
